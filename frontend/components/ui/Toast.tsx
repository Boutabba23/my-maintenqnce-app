...
const Toast: React.FC<ToastProps> = ({ toast, onDismiss }) => {
  ...
  return (
    <div
      className={`
        flex items-start w-full max-w-sm p-4 space-x-4 rounded-lg shadow-lg bg-card border border-border
    ...
    >
      ...
      <button
        ...
        className="flex-shrink-0 p-1 -m-1 rounded-full hover:bg-muted"
        aria-label="Fermer"
      >
