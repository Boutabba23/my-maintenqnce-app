...
const Table: React.FC<React.HTMLAttributes<HTMLTableElement> & { wrapperClassName?: string; isMenuOpen?: boolean }> = ({ className, wrapperClassName, isMenuOpen, ...props }) => (
  <div className={`relative w-full ${isMenuOpen ? 'overflow-visible' : 'overflow-x-auto'} ${wrapperClassName || ''}`}>
